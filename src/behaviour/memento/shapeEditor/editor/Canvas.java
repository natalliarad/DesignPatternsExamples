...
import behaviour.memento.shapeEditor.commands.ColorCommand;
import behaviour.memento.shapeEditor.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        final MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(final MouseEvent e) {
                ...
                final Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
        ...
        final MouseAdapter selector = new MouseAdapter() {
            ...
            public void mousePressed(final MouseEvent e) {
                ...
                final Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                final boolean ctrl = (e.getModifiers() & ActionEvent.CTRL_MASK) == ActionEvent.CTRL_MASK;
